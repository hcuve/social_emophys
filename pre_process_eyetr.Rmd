...
# dta_gp_agg_fix_sacc_w_of_aoixy_stim1<- dta_gp_agg_fix_sacc_w_of_aoixy_stim1%>%
#   mutate(across(c(mean_dwell_dur, mean_fix_dur, mean_sac_dur, 
#                   sum_dwell_dur, sum_fix_dur, sum_sac_dur, 
#                   # mean_rms, mean_po_gsd, mean_sac_amp, 
#                   count_fix, count_sacc),
#                 ~replace(., is.na(.) | is.nan(.), 0)))%>%
#   group_by(ssid, participant, text, pratice_vs_trial, stimnopath, filename2, trial,aoi_name) %>%
#   summarise_if(is.numeric, mean, na.rm = T)
