...
gazepath_results_fix <- readRDS("~/Library/CloudStorage/OneDrive-UniversityofBristol/Research Projects/EmotionPhysio2024/2023-24 Project/Data backup/Eyetracking/preprocessed/for_fix_sac/GPRESULTS/gazepath_results_fix.rds")
gp_summary_results_fix <- readRDS("~/Library/CloudStorage/OneDrive-UniversityofBristol/Research Projects/EmotionPhysio2024/2023-24 Project/Data backup/Eyetracking/preprocessed/for_fix_sac/GPRESULTS/gp_summary_results_fix.rds")
gazepath_results_rest <- readRDS("~/Library/CloudStorage/OneDrive-UniversityofBristol/Research Projects/EmotionPhysio2024/2023-24 Project/Data backup/Eyetracking/preprocessed/for_fix_sac/GPRESULTS/gazepath_results_rest.rds")
gp_summary_results_rest <-readRDS("~/Library/CloudStorage/OneDrive-UniversityofBristol/Research Projects/EmotionPhysio2024/2023-24 Project/Data backup/Eyetracking/preprocessed/for_fix_sac/GPRESULTS/gp_summary_results_rest.rds")
...
```{r}
dta_gp_all_fix_sacc <- bind_rows(gp_summary_results_rest, gp_summary_results_fix, gp_summary_results_stim)%>%
...
- measures of duration (averages)
- aoi towards vs away of the image
- entropy - normalised by complexity of the image

- eccentricity asa further measure to aoi (to tell us whether they are looking towards the image or not) - looking towards the center of mass or not
