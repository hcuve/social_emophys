...
dta_4gazepath <- dta_4gazepath %>%
  mutate(split_column = paste0(ssid, "_", text))
...
unique(dta_4gazepath$screencontent_no_na)


dta_4gazepath <- dta_4gazepath %>%
  mutate(split_column = paste0(ssid, "_", screencontent_no_na))

# Split the data frame into a list of data frames based on the unique combinations
tmp_split_df <- split(dta_4gazepath, dta_4gazepath$split_column)

dta_4gazepath_stim<- dta_4gazepath%>%
  subset(screencontent_no_na == "stimuli")


dta_4gazepath_fix<- dta_4gazepath%>%
  subset(screencontent_no_na == "fixation")


dta_4gazepath_rest<- dta_4gazepath%>%
...
# Split the data frame into a list of data frames based on the unique combinations
tmp_split_df <- split(dta_4gazepath_stim, dta_4gazepath_stim$split_column)
...
dta_4gazepath$trial_no<- if_else(dta_4gazepath$pratice_vs_trial == "Pratice", 
                                         dta_4gazepath$trial_no+1,
                                 if_else(dta_4gazepath$pratice_vs_trial == "Trial",
