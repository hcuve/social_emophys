...
<!-- what5s the diferencve with the individual folders -->
...
# assuming 1.5 hours times 93 peoples recordings made at 128 hz, how many rows should we expect this data to have
...
# so these either need to be renamed manually or programatically
```
...
insppect some fo teh saved ouputs and plots and liusyt of problem files any files you can't run in batch mode run manualy
