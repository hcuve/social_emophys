...
# "105" "108" "110" "111" "113" "114" "201" "204" "205" "208" "209" "213" "220" #### 119 was mistaklenly set as 118
...
for (participant_id in participant_ids) {
  ...
  for (i in 1:nrow(participant_files)) {
    ...
    # Check if there's an extra empty column and remove it if necessary
    # Ensure Consistent Column Removal: You might need a more robust way to check for and remove extra columns. For instance, if the extra columns are always at the end and there's a possibility of having more than one extra column, you might adjust the column removal step based on the difference in lengths:
